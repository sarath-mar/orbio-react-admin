...
export default function PermanentDrawerLeft(props) {
    ...
    const LowerData = [
        {
            icon: <svg width="44" height="45" viewBox="0 0 44 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M19.3094 11.9286C17.3197 10.4927 14.5416 11.9226 14.5538 14.3762L14.5574 15.1013C14.5642 16.4528 13.6664 17.6419 12.3648 18.0056L11.6665 18.2007C9.30333 18.861 8.68911 21.9245 10.615 23.4448L11.1842 23.8941C12.245 24.7314 12.6149 26.1747 12.0877 27.4191L11.8049 28.0868C10.8478 30.346 12.8599 32.7363 15.2493 32.1784L15.9555 32.0136C17.2715 31.7063 18.6306 32.3169 19.2748 33.505L19.6204 34.1424C20.7901 36.2993 23.9134 36.2165 24.967 34.0006L25.2784 33.3457C25.8587 32.1252 27.1835 31.4433 28.514 31.6804L29.2279 31.8076C31.6435 32.238 33.5261 29.7444 32.4505 27.539L32.1326 26.8873C31.5402 25.6726 31.8331 24.2117 32.848 23.3193L33.3925 22.8405C35.2351 21.2202 34.4593 18.1936 32.0645 17.6595L31.3568 17.5017C30.0377 17.2075 29.0782 16.0677 29.0133 14.7178L28.9784 13.9935C28.8605 11.5427 26.0105 10.2622 24.0998 11.8015L23.5351 12.2564C22.4827 13.1043 20.9933 13.1438 19.8974 12.3529L19.3094 11.9286ZM22 27C24.2091 27 26 25.2091 26 23C26 20.7909 24.2091 19 22 19C19.7908 19 18 20.7909 18 23C18 25.2091 19.7908 27 22 27Z" fill="white" />
            </svg>,
            text: "Settings"
        },
        {
            icon: <svg width="44" height="45" viewBox="0 0 44 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                <ellipse cx="15.9678" cy="20.5833" rx="4.6129" ry="4.58333" fill="white" />
                <ellipse cx="28.5484" cy="18.9167" rx="2.93548" ry="2.91667" fill="white" />
                <path d="M23.9355 33.9167C23.9355 32.9865 23.7294 32.0654 23.329 31.206C22.9286 30.3466 22.3417 29.5658 21.6018 28.908C20.8619 28.2503 19.9836 27.7285 19.0169 27.3725C18.0502 27.0166 17.0141 26.8333 15.9677 26.8333C14.9214 26.8333 13.8853 27.0166 12.9186 27.3725C11.9519 27.7285 11.0736 28.2503 10.3337 28.908C9.59382 29.5658 9.00692 30.3466 8.60651 31.206C8.20609 32.0654 8 32.9865 8 33.9167L15.9677 33.9167H23.9355Z" fill="white" />
                <path d="M34 28.0833C34 27.4814 33.859 26.8854 33.585 26.3294C33.3111 25.7733 32.9095 25.268 32.4033 24.8424C31.8971 24.4168 31.2961 24.0792 30.6347 23.8489C29.9732 23.6186 29.2643 23.5 28.5484 23.5C27.8325 23.5 27.1236 23.6186 26.4622 23.8489C25.8008 24.0792 25.1998 24.4168 24.6935 24.8424C24.1873 25.268 23.7858 25.7733 23.5118 26.3294C23.2378 26.8854 23.0968 27.4814 23.0968 28.0833L28.5484 28.0833H34Z" fill="white" />
            </svg>,
            text: "Users"
        },
    ]
    ...
    return (
        ...
        <Box sx={{ display: 'flex' }}>
            ...
            >
                <Toolbar sx={{ display: "flex", justifyContent: "space-between" }}>
                    ...
                    <div style={{ display: "flex", }}>
                        ...
                        {backIcon}
                        <Typography sx={{ ml: 3 }} color={"primary.textColor"} variant="h6" noWrap component="div">
                            Audit Findings
                        </Typography>
                    </div>
                    <div>
            ...
            >
                {/* <Toolbar /> */}
                <IconButton style={{ marginLeft: "auto", color: "white" }} onClick={handleDrawerClose}>
                    {<ChevronLeftIcon />}
                </IconButton>
                <div
                        ...
                        {dashBoardData.map((data, index) => (
                            <ListItem key={data} disablePadding sx={{ mb: 2 }}>
                                <ListItemButton sx={{ display: "flex", flexDirection: "column" }}>
                                    {data.icon}
                                    <p style={{ fontSize: "14px", color: 'white', textAlign: "center", margin: '0px' }}>
                                        {data.text}
                                    </p>
                                </ListItemButton>
                            </ListItem>
